...
try:
    ...
    try:
        ...
        raise EnvironmentError('TemporaryDirectory is not available in Python 2. '
                               'Try installing backports with "pip install backports.tempfile" OR'
                               'specify python to use, e.g.: "export TREZOR_PYTHON=`which python3`"')
