...
enum MessageType {
  ...
  MessageType_OntologySignTx = 354,
  MessageType_OntologySignedTx = 355,
  MessageType_OntologySignTransfer = 356,
  MessageType_OntologySignedTransfer = 357,
  MessageType_OntologySignWithdrawOng = 358,
  MessageType_OntologySignedWithdrawOng = 359,
